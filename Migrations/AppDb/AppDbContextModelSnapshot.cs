...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("websitehoa.Models.AspNetUser", b =>
                {
            ...
            modelBuilder.Entity("websitehoa.Models.ChiTietDonHang", b =>
                {
            ...
            modelBuilder.Entity("websitehoa.Models.DanhGium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("websitehoa.Models.DanhMuc", b =>
                {
            ...
            modelBuilder.Entity("websitehoa.Models.DichVu", b =>
                {
            ...
            modelBuilder.Entity("websitehoa.Models.DonHang", b =>
                {
                    b.Property<int>("Madon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("websitehoa.Models.KhachHang", b =>
                {
                    b.Property<int>("Makh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("websitehoa.Models.KhachHangRole", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int")
                        .HasColumnName("RoleID");
            ...
            modelBuilder.Entity("websitehoa.Models.SanPham", b =>
                {
                    b.Property<int>("Masp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("websitehoa.Models.ThuVienAnh", b =>
                {
                    b.Property<int>("Idthuvien")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("websitehoa.Models.ChiTietDonHang", b =>
                {
                    b.HasOne("websitehoa.Models.DonHang", "MadonNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Madon")
                        .HasConstraintName("FK__ChiTietDo__madon__36B12243")
                        .IsRequired();

                    b.HasOne("websitehoa.Models.SanPham", "MaspNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Masp")
            ...
            modelBuilder.Entity("websitehoa.Models.DanhGium", b =>
                {
                    b.HasOne("websitehoa.Models.KhachHang", "IdKhNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdKh")
                        .HasConstraintName("FK__DanhGia__id_kh__3C69FB99");

                    b.HasOne("websitehoa.Models.SanPham", "IdSpNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdSp")
            ...
            modelBuilder.Entity("websitehoa.Models.DichVu", b =>
                {
                    b.HasOne("websitehoa.Models.KhachHang", "MakhNavigation")
                        .WithMany("DichVus")
                        .HasForeignKey("Makh")
            ...
            modelBuilder.Entity("websitehoa.Models.KhachHang", b =>
                {
                    b.HasOne("websitehoa.Models.KhachHangRole", "Role")
                        .WithMany("KhachHangs")
            ...
            modelBuilder.Entity("websitehoa.Models.SanPham", b =>
                {
                    b.HasOne("websitehoa.Models.DanhMuc", "IdDanhmucNavigation")
                        .WithMany("SanPhams")
                        .HasForeignKey("IdDanhmuc")
                        .HasConstraintName("FK__SanPham__idDanhm__286302EC");

                    b.HasOne("websitehoa.Models.ThuVienAnh", "IdthuvienNavigation")
                        .WithMany("SanPhams")
